...
command! -nargs=1 HimalayaMbox        call himalaya#folder#handle_select(<f-args>)
command! -nargs=* HimalayaMboxList    call himalaya#folder#select()
command! -nargs=* HimalayaNextPage    call himalaya#folder#next_page()
command! -nargs=* HimalayaPrevPage    call himalaya#folder#prev_page()
